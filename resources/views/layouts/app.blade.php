                ...
                <div class="container-fluid container-sm px-sm-5 position-relative">
                    ...
                    <div class="collapse navbar-collapse" id="navbarLinksContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder align-top">
                            ...
                            <li class="nav-item"><a class="nav-link" role="button" href="{{ route('dashboard.customers') }}">Clients</a></li>
                            <li class="nav-item d-lg-none d-inline-block">
                                <form action="{{ route('logout') }}" method="POST">
@csrf
                                    <button class="nav-link border-0 bg-transparent py-2" href="{{ route('dashboard.customers') }}">Quitte la session</button>
                                </form>
                            </li>
                        </ul>
                    </div>
                    <div class="dropdown">
                        <a role="button" class="d-lg-inline-block d-none flex-row ms-5 my-3 rounded-pill user-account" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img src="{{ !empty(Auth::user()->avatar_url) ? getWebURL() . Auth::user()->avatar_url : asset('assets/img/user.png') }}" alt="Patrice Mubiayi" width="50" class="ms-1 rounded-circle">
                        </a>
